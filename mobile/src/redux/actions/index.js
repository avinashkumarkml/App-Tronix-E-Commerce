...
export const mobiles_api = () => (dispatch) => {
  dispatch(loading());
  axios.get("https://apptronix-store-apis.onrender.com/mobiles").then((res) => {
    dispatch(getProduct(res.data));
  });
};
export const get_cart_data = () => (dispatch) => {
  dispatch(loading());
  axios.get("https://apptronix-store-apis.onrender.com/mobilecart").then((res) => {
...
export const laptops_api = () => (dispatch) => {
  dispatch(loading());
  axios.get("https://apptronix-store-apis.onrender.com/laptops").then((res) => {
    dispatch(getProductlaptop(res.data));
  });
};
export const ipads_api = () => (dispatch) => {
  dispatch(loading());
  axios.get("https://apptronix-store-apis.onrender.com/ipads").then((res) => {
...
export const mobile_id = (id) => (dispatch) => {
  axios.get(`https://apptronix-store-apis.onrender.com/mobiles/${id}`).then((res) => {
    dispatch(getProductDetails(res.data));
  });
};
export const laptop_id = (id) => (dispatch) => {
  axios.get(`https://apptronix-store-apis.onrender.com/laptops/${id}`).then((res) => {
    dispatch(getProductDetails(res.data));
  });
};
export const ipad_id = (id) => (dispatch) => {
  axios.get(`https://apptronix-store-apis.onrender.com/ipads/${id}`).then((res) => {
    dispatch(getProductDetails(res.data));
  });
};
